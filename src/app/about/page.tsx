...
// import first_about from "../../../components/first_about";
    ...
    <>
      <div className="hero-container">
        <div className="containt-text1">
          ...
          <a href="" className="home-group">
            ...
            <span className="linkabout">About Us</span>
          </a>
          <img
        ...
        <div className="image-hero-container">
          <img
            ...
            alt=""
            className="dotroundimg1"
          />
          <img
            src="https://wordpressriverthemes.com/htmltemp/pixlab/assets/images/breadcrumb/img-1.jpg"
            alt=""
            className="herooneimg1"
          />
        </div>
      </div>
      {/* ==secound-section= */}
      <div className="container-About1">
        <div className="About-img1">
          <img
            src="https://wordpressriverthemes.com/htmltemp/pixlab/assets/images/about/about-4.png"
            alt=""
            className=""
          />
        </div>
        <div className="About-text-img1">
          <div className="roun2img">
            <p> About Us</p>
          </div>
          <h2 className="best-provider">
          ...
          <div className="list-group">
            <div className="main-icon-text">
              ...
              <div className="icon-text">
                <a href="">Digital Creative Agency</a>
              </div>
            </div>
            <div className="main-icon-text">
              <div className="icons-tick">
              ...
              <div className="icon-text">
                <a href="">Professional Problem Solutions</a>
              </div>
            </div>
            <div className="main-icon-text">
              <div className="icons-tick">
      ...
      <div className="container-third">
        <div className="card-group1">
          <div className="card1">
            ...
            <div className="main-arro-text-services1">
              <span className="arroicon1">
                <AiOutlineArrowRight />
              </span>
      ...
      <div className="container-About1">
        <div className="About-text-img1">
          ...
          <p className="About-paragraph1">
            ...
            dicta sunt explicabo. Nemo enimpsam luptatem quia voluptas
            aspernatur aut fugitdolor sit amet
          </p>

          <div className="outline-btn1">
            Discover More
            <span>
              <AiOutlineArrowRight />
            </span>
        ...
        <div className="About-img1">
          <img
            src="https://wordpressriverthemes.com/htmltemp/pixlab/assets/images/about/img-4.jpg"
            alt=""
          />
        </div>
      </div>
